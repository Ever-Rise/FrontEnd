...
type HookKind = 'useContext' | 'useState' | 'useActionState' | 'useReducer' | 'useRef' | 'useEffect' | 'useLayoutEffect' | 'useInsertionEffect' | 'useMemo' | 'useCallback' | 'useTransition' | 'useImperativeHandle' | 'useEffectEvent' | 'useOptimistic' | 'Custom';
...
declare const EnvironmentConfigSchema: z.ZodObject<{
    ...
    customMacros: z.ZodDefault<z.ZodNullable<z.ZodArray<z.ZodString>>>;
    ...
    validateExhaustiveMemoizationDependencies: z.ZodDefault<z.ZodBoolean>;
    validateExhaustiveEffectDependencies: z.ZodDefault<z.ZodEnum<{
        off: "off";
        all: "all";
    ...
    validateSourceLocations: z.ZodDefault<z.ZodBoolean>;
    ...
    enableVerboseNoSetStateInEffect: z.ZodDefault<z.ZodBoolean>;
}, z.core.$strip>;
...
declare class Environment {
    ...
    constructor(scope: Scope, fnType: ReactFunctionType, outputMode: CompilerOutputMode, config: EnvironmentConfig, contextIdentifiers: Set<t.Identifier>, parentFunction: NodePath<t.Function>, logger: Logger | null, filename: string | null, code: string | null, programContext: ProgramContext);
...
declare class CompilerError extends Error {
    ...
    static invariant(condition: unknown, options: {
...
declare function compileFn(func: NodePath<t.FunctionDeclaration | t.ArrowFunctionExpression | t.FunctionExpression>, config: EnvironmentConfig, fnType: ReactFunctionType, mode: CompilerOutputMode, programContext: ProgramContext, logger: Logger | null, filename: string | null, code: string | null): Result<CodegenFunction, CompilerError>;
...
declare const CompilerOutputModeSchema: z.ZodEnum<{
    client: "client";
    ssr: "ssr";
    lint: "lint";
}>;
type CompilerOutputMode = z.infer<typeof CompilerOutputModeSchema>;
type LoggerEvent = CompileSuccessEvent | CompileErrorEvent | CompileDiagnosticEvent | CompileSkipEvent | CompileUnexpectedThrowEvent | PipelineErrorEvent | TimingEvent;
...
type CompileUnexpectedThrowEvent = {
...
declare const defaultOptions: ParsedPluginOptions;
...
export { type CompileSuccessEvent, CompilerDiagnostic, type CompilerDiagnosticDetail, type CompilerDiagnosticOptions, CompilerError, CompilerErrorDetail, type CompilerErrorDetailOptions, type CompilerPipelineValue, CompilerSuggestionOperation, Effect, type EnvironmentConfig, ErrorCategory, ErrorSeverity, type ExternalFunction, type Hook, type LintRule, LintRulePreset, LintRules, type Logger, type LoggerEvent, OPT_IN_DIRECTIVES, OPT_OUT_DIRECTIVES, type PluginOptions, ProgramContext, type SourceLocation, ValueKind, ValueReason, compileFn as compile, compileProgram, BabelPluginReactCompiler as default, defaultOptions, findDirectiveDisablingMemoization, tryFindDirectiveEnablingMemoization as findDirectiveEnablingMemoization, parseConfigPragmaForTests, parsePluginOptions, printFunctionWithOutlined, printHIR, printReactiveFunction, printReactiveFunctionWithOutlined, runBabelPluginReactCompiler, validateEnvironmentConfig };
