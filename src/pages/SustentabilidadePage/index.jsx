...
const impactCards = [
    {
        ...
        title: "Sustentável",
        description:
            "Reduzimos resíduos e preservamos o ciclo de vida dos materiais.",
    },
    {
        icon: iconInteligente,
        title: "Inteligente",
        description:
            "Processo rastreável, eficiente e integrado com tecnologia própria.",
    },
    {
        icon: iconPessoas,
        title: "Social",
    ...
    return (
        <div className={styles.container}>
            ...
            <main className={styles.main} style={{ paddingTop: "76px" }}>
                ...
                <section className={styles.impactSection}>
                    ...
                    <p className={styles.sectionLead}>
                        Cada etapa foi pensada para comunicar confiança,
                        simplicidade e resultado mensurável.
                    </p>
                ...
                <section className={styles.howItWorks}>
                    ...
                    <div className={styles.timeline}>
                        {processSteps.map((step, index) => (
                            <div
                                key={step.title}
                                className={`${styles.timelineItem} ${timelineClassNames[index]}`}
                            >
                ...
                <section
                    ...
                    style={{ backgroundImage: `url(${impactoImg})` }}
                >
                    <div className={styles.ctaContent}>
                        <h2>Pronto para gerar impacto?</h2>
                        <p>
                            Junte-se a nós para transformar o descarte em
                            retorno positivo para o planeta e para as pessoas.
                        </p>
                        <button className={styles.btnPrimary}>
                ...
                <section className={styles.numbersSection}>
                    <div className={styles.numbersHeader}>
                        ...
                        <p className={styles.sectionLead}>
                            A experiência foi organizada para deixar os
                            indicadores em evidência e reforçar a confiança na
                            operação.
                        </p>
                    </div>
                ...
                <section className={styles.formSection}>
                    <div className={styles.formContainer}>
                        <h3 className={styles.formTitle}>
                            Solicite logística reversa
                        </h3>
                        <p className={styles.formSubtitle}>
                            Preencha os dados abaixo e siga para a etapa de
                            coleta com a identidade visual da página.
                        </p>
                    ...
                    <aside className={styles.evaluationContainer}>
                        <div className={styles.evaluationBox}>
                            ...
                            <p className={styles.evaluationText}>
                                A devolução passa por uma avaliação
                                especializada para definir reaproveitamento,
                                reciclagem e o desconto final.
                            </p>
            ...
            <footer
                ...
                style={{ backgroundImage: `url(${contatoImg})` }}
            >
                <div className={styles.newsletter}>
                    <h3>Futuro melhor começa com escolhas conscientes.</h3>
                    <p>
                        Receba novidades sobre logística reversa, impacto e
                        novas campanhas.
                    </p>
