            ...
            <section className={styles.page}>
                ...
                <div className={styles.layout}>
                    ...
                    >
                        ...
                        {/* Endereço de Entrega */}
                        <h2 className={styles.sectionTitleSpaced}>
                            Endereço de Entrega
                        </h2>
                        ...
                        <div className={styles.deliveryOptions}>
                            ...
                            >
                                ...
                                <div
                                    className={`${styles.deliveryPrice} ${styles.deliveryPriceFree}`}
                                >
                                    Grátis
                                </div>
                            </label>
                        ...
                        {paymentTab === "boleto" && (
                            <div className={styles.formField}>
                                ...
                                >
                                    ...
                                    Prazo de 3 dias úteis para compensação.
                                </p>
                            </div>
                        )}
                    </form>
                    ...
                    <aside className={styles.right}>
                        <section className={styles.orderCard}>
                            <div className={styles.productRow}>
                                ...
                                <div className={styles.productInfo}>
                                    <div className={styles.productName}>
                                        Guincho de Transferência Ever Rise
                                    </div>
                            ...
                            <div className={styles.summaryRows}>
                                ...
                                <div className={styles.summaryRow}>
                                    <span>Frete</span>
                                    <span className={styles.summaryRowFree}>
                                        Grátis
                                    </span>
                                </div>
                                <div className={styles.summaryRow}>
                                    <span>Impostos</span>
                                    <span className={styles.summaryRowInc}>
                                        Inclusos
                                    </span>
                                </div>
                        ...
                        <section className={styles.supportCard}>
                            ...
                            <div>
                                ...
                                <div className={styles.supportText}>
                                    Ao finalizar este pedido, você recebe 1 ano
                                    de suporte dedicado 24/7 para sua
                                    instituição.
                                </div>
                            </div>
                        </section>
