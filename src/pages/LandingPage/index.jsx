...
const IconConnect = () => (
    <svg width="36" height="36" viewBox="0 0 24 24" fill="none">
        ...
        <path
            d="M10.6 6.6L6.6 16M13.4 6.6l4 9.4M7.4 18h9.2"
            stroke="currentColor"
            strokeWidth="1.8"
            strokeLinecap="round"
        />
...
const IconControl = () => (
    <svg width="36" height="36" viewBox="0 0 24 24" fill="none">
        <path
            d="M4 19V11M10 19V5M16 19v-7M21 19H3"
            stroke="currentColor"
            strokeWidth="2"
            strokeLinecap="round"
            strokeLinejoin="round"
...
const IconFamily = () => (
    <svg width="32" height="32" viewBox="0 0 24 24" fill="none">
        ...
        />
        <path
            d="M2.5 19c0-3 2.6-5 5.5-5s5.5 2 5.5 5M10.5 19c0-3 2.6-5 5.5-5s5.5 2 5.5 5"
            stroke="currentColor"
            strokeWidth="1.8"
            strokeLinecap="round"
        />
...
const IconOngs = () => (
    <svg width="32" height="32" viewBox="0 0 24 24" fill="none">
        <path
            d="M12 21s-7-4.4-9.3-8.8C1.2 9 2.7 5.6 6 4.9c2-.4 3.7.6 6 2.8 2.3-2.2 4-3.2 6-2.8 3.3.7 4.8 4.1 3.3 7.3C19 16.6 12 21 12 21z"
            stroke="currentColor"
            strokeWidth="1.7"
            strokeLinejoin="round"
        />
...
const IconPortrait = () => (
    <svg width="160" height="160" viewBox="0 0 24 24" fill="none">
        ...
        <path
            d="M3.5 21c0-5 3.8-8 8.5-8s8.5 3 8.5 8"
            fill="#fff"
            fillOpacity="0.9"
        />
    </svg>
            ...
            ([entry]) => {
                if (entry.isIntersecting && !started.current) {
                    ...
                    function update(now) {
                        ...
                        const v = end * eased;
                        setValue(
                            isFloat ? parseFloat(v.toFixed(1)) : Math.round(v),
                        );
...
const testimonials = [
    {
        text: "A EVER RISE mudou a forma como gerencio meus caminhões. O tempo de resposta caiu pela metade e a satisfação dos clientes subiu instantaneamente.",
...
const testimonialsRow2 = [
    ...
    {
        text: "Como ONG, precisávamos de transparência para nossos doadores. O EVER RISE nos deu exatamente isso.",
            ...
            <div className={styles.page}>
                ...
                <section className={styles.hero}>
                    ...
                    <div className={styles.heroContent}>
                        ...
                        <p className={styles.heroSubtitle}>
                            O Ever Rise conecta famílias, clínicas e ONGs a um
                            sistema simples de rastreamento e gestão em tempo
                        ...
                        <div className={styles.heroActions}>
                            ...
                            <button
                                className={styles.btnOrangeSoft}
                                onClick={() => navigate("/vendas")}
                            >
                                Ver demonstração
                            </button>
                ...
                <section className={styles.founder}>
                    ...
                    <div className={styles.founderLeft}>
                        ...
                        <p className={styles.founderText}>
                            A história da Ever Rise não começou em uma prancheta
                            isolada, mas sim na vivência prática de um problema
                            real. Depois da Rafa e Dona Lidia (Sua mãe)
                            enfrentar na pele a dificuldade de gerenciar um
                            guincho, lidando com equipamento sem segurança. Ela
                            se uniu aos seus amigos para mudar essa realidade.
                        </p>
                        <p className={styles.founderText}>
                            Juntos, eles uniram forças, ideias e competências
                            para construir a Ever Rise. O produto nasceu dessa
                            necessidade genuína e foi totalmente desenhado para
                            quem precisa de clareza, segurança e eficiência, sem
                            espaço para complexidade desnecessária.
                        </p>
                    </div>
                    ...
                    <div className={styles.founderImageWrap}>
                        ...
                        <div className={styles.founderQuote}>
                            <p>
                                "Eu não queria mais uma ferramenta. Queria algo
                                que fizesse o trabalho desaparecer — para que eu
                                pudesse focar nas pessoas."
                            </p>
                            <div className={styles.founderQuoteName}>Rafa</div>
                            <div className={styles.founderQuoteRole}>
                                Idealizadora da EVER RISE
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className={styles.audience}>
                    ...
                    <div className={styles.audienceHeadingWrap}>
                        <h2 className={styles.audienceHeading}>
                ...
                <section className={styles.testimonials}>
                    ...
                    <div className={styles.carouselDouble}>
                        ...
                        <div
                            className={`${styles.carouselRow} ${styles.carouselRowReverse}`}
                        >
                            <div className={styles.carouselTrack}>
                                {[...testimonialsRow2, ...testimonialsRow2].map(
                                    (t, idx) => (
                                        <div
                                            className={styles.testimonialCard}
                                            key={idx}
                    ...
                    <div className={styles.pricingRow}>
                        {plans.map((p) => (
                            ...
                            >
                                ...
                                {p.price === "Custom" ? (
                                    <p className={styles.planPriceCustom}>
                                        {p.price}
                                    </p>
                                ) : (
                ...
                <section className={styles.cta}>
                    ...
                    <p className={styles.ctaText}>
                        ...
                        seus processos com a EVER RISE.
                    </p>
                    <div className={styles.ctaActions}>
                        ...
                        <button className={styles.btnOutline} onClick={() => navigate("/vendas")}>
