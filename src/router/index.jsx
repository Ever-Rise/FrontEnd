...
const SustentabilidadePage = lazy(() => import('../pages/SustentabilidadePage'));
      ...
      return (
        ...
        >
          <div>
            ...
            <p>Tente atualizar a pagina. Se o problema continuar, contate o suporte EVERRISE.</p>
          </div>
        </main>
      );
    }
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { path: '/sustentabilidade', element: withSuspense(SustentabilidadePage) },
